...
#heading "($BUILDNUM/$BUILDCOUNT) Building Ewe"
# update_project_package $OBS_LOCAL_DIR/ewe/
#BUILDNUM=$(($BUILDNUM+1))
...
heading "($BUILDNUM/$BUILDCOUNT) Building Enlightenment"
 update_project_package $OBS_LOCAL_DIR/enlightenment/
BUILDNUM=$(($BUILDNUM+1))
...
#heading "($BUILDNUM/$BUILDCOUNT) Building Rage"
#update_project_package $OBS_LOCAL_DIR/rage/
#BUILDNUM=$(($BUILDNUM+1))

#heading "($BUILDNUM/$BUILDCOUNT) Building Epymc"
#update_project_package $OBS_LOCAL_DIR/epymc/
#BUILDNUM=$(($BUILDNUM+1))

#heading "($BUILDNUM/$BUILDCOUNT) Building Epour"
#update_project_package $OBS_LOCAL_DIR/epour/
#BUILDNUM=$(($BUILDNUM+1))

heading "($BUILDNUM/$BUILDCOUNT) Building Enventor"
update_project_package $OBS_LOCAL_DIR/enventor/
BUILDNUM=$(($BUILDNUM+1))

#heading "($BUILDNUM/$BUILDCOUNT) Building eflete"
#update_project_package $OBS_LOCAL_DIR/eflete/
#BUILDNUM=$(($BUILDNUM+1))
